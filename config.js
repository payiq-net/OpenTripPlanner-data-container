...
const FINLAND_CONFIG = {
  'id': 'finland',
  'src': [
    src('HSL', 'https://infopalvelut.storage.hsldev.com/gtfs/hsl.zip', false, ['router-finland/gtfs-rules/hsl.rule', 'router-finland/gtfs-rules/hsl-no-trains.rule'], { 'translations.txt': 'translations_new.txt' }),
