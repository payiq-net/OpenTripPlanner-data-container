...
const routers = {
  ...
  finland: {
    ...
    src: [
      ...
      src('MATKA', 'https://koontikartta.navici.com/tiedostot/gtfs_digitransit.zip', false, ['finland/gtfs-rules/matka-cleaned.rule']),
      src('tampere', 'http://ekstrat.tampere.fi/ekstrat/ptdata/tamperefeed_deprecated.zip'),
      src('LINKKI', 'https://tvv.fra1.digitaloceanspaces.com/209.zip'),
      ...
      src('Hameenlinna', 'https://tvv.fra1.digitaloceanspaces.com/203.zip'),
      src('Kotka', 'https://tvv.fra1.digitaloceanspaces.com/217.zip'),
      src('Kouvola', 'https://tvv.fra1.digitaloceanspaces.com/219.zip'),
      src('Lappeenranta', 'https://tvv.fra1.digitaloceanspaces.com/225.zip'),
      src('Mikkeli', 'https://tvv.fra1.digitaloceanspaces.com/227.zip'),
      src('Vaasa', 'https://tvv.fra1.digitaloceanspaces.com/249.zip'),
      src('Joensuu', 'https://tvv.fra1.digitaloceanspaces.com/207.zip'),
      src('FOLI', 'http://data.foli.fi/gtfs/gtfs.zip'),
      src('Lahti', 'https://tvv.fra1.digitaloceanspaces.com/223.zip'),
      src('Kuopio', 'http://karttapalvelu.kuopio.fi/google_transit/google_transit.zip'),
      src('Rovaniemi', 'https://tvv.fra1.digitaloceanspaces.com/237.zip'),
      src('Kajaani', 'https://tvv.fra1.digitaloceanspaces.com/211.zip'),
      src('Salo', 'https://tvv.fra1.digitaloceanspaces.com/239.zip'),
      src('Pori', 'https://tvv.fra1.digitaloceanspaces.com/231.zip'),
      ...
      src('Raasepori', 'https://tvv.fra1.digitaloceanspaces.com/232.zip'),
