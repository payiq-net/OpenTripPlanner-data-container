...
const routers = {
  ...
  finland: {
    ...
    src: [
      ...
      src('LINKKI', 'geocoding.blob.core.windows.net/vrk/jkl.zip', false, undefined, {'fare_attributes.txt': 'digitransit_fare_attributes.txt', 'fare_rules.txt': 'digitransit_fare_rules.txt'}),
